...
import copy
from models.config import CNN_MODEL_PATH, device
from .utils import (
    evaluate,
    train_one_epoch,
    plot_curves,
...
def train_cnn(train_loader, val_loader, save_plot=False):
    """Обучает и сохраняет CNN модель, выбирая лучшие веса"""
